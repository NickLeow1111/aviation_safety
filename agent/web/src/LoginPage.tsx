    ...
    <div className="login-page">
      ...
      <div className="login-container">
        ...
        <div className="login-brand">
          ...
          <h1 className="login-title">Safety Intelligence Bot</h1>
          <p className="login-subtitle">Civil Aviation Authority of Singapore</p>
        </div>
        ...
        <div className="login-card">
          <div className="login-card-header">
            <h2>Welcome back</h2>
            <p>Sign in to access the safety intelligence platform</p>
          </div>
